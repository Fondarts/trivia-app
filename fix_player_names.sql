-- Script para actualizar nombres de jugadores en partidas existentes
...
-- Convertir UUID a texto antes de usar SUBSTRING
UPDATE public.async_matches 
SET player1_name = 'Jugador ' || SUBSTRING(player1_id::text, 1, 4)
WHERE player1_name = 'Anon' OR player1_name IS NULL OR player1_name = '';

UPDATE public.async_matches 
SET player2_name = 'Jugador ' || SUBSTRING(player2_id::text, 1, 4)
